							...
							>
								...
								{#each duplicateGroups as group}
									<div class="mb-4 rounded-md border-2 border-neutral-600 p-2">
										<h3 class="font-5xl mb-2 text-center text-xl text-neutral-200">
											{group.label}
										</h3>
										<div class="space-y-2">
											{#each group.options as option}
												...
												>
													...
													<span class="text-neutral-200">
														Status: {option.derived_status} · Job Date: {option.job_date ?? '—'} · Job
														No:
														{option.job_no ?? '—'} · Model No:
								...
								<div class="mt-4 flex justify-end gap-3">
									<button type="button" class={uiStyles.c0100} onclick={closeDuplicateModal}
										>Close</button
									>
									<button
										type="submit"
